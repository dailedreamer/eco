...
export default {
    ...
    computed:{
        rows() {
            return this.for_pc_list.length
        }
    },
    methods:{
        updateForPC: function(id){
            this.status_name = "For PC";
            this.status_id = "5";
            this.id = {};
            this.id = this.for_pc_list[id];
        },
        // forPcSubparts: function(){
        //     alert("Open For PC Subparts Modal");
        // }
    }
}
</script>
