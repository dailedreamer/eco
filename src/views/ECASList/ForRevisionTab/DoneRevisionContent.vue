        ...
        <b-row class="mt-4">
            <b-col cols="12">
                <b-table 
                    ...
                    responsive 
                    small
                    :items="done_revision_list"
                    :fields="done_revision_fields"
                    :per-page="perPage"
        ...
        <b-row class="mt-4">
            <b-col cols="12">
                <b-button 
                    ...
                    <font-awesome-icon icon="thumbs-up" /> Done Revision
                </b-button> 
            </b-col>
        </b-row>
    </b-container>
...
export default {
    ...
    computed:{
        rows() {
            return this.done_revision_list.length
        }
    },
}
</script>
