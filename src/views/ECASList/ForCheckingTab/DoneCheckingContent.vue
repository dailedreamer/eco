        ...
        <b-row class="mt-4">
            <b-col cols="12">
                <b-table 
                    ...
                    responsive 
                    small
                    :items="done_checking_list"
                    :fields="done_checking_fields"
                    :per-page="perPage"
        ...
        <b-row class="mt-4">
            <b-col cols="12">
                <b-button 
                    ...
                    @click="done_checking()">
                    <font-awesome-icon icon="thumbs-up" /> Done Checking
                </b-button> 
            </b-col>
        </b-row>
    </b-container>
...
export default {
    ...
    computed:{
        rows() {
            return this.done_checking_list.length
        }
    },
    methods:{
        done_checking(){
